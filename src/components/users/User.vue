...
export default {
  ...
  methods: {
    ...mapActions(['getUser', 'addUser', 'editUser', 'unsetUser']),
  ...
  <div class="row">
    ...
    <form @submit.prevent="formSubmit(user)" class="col s12">
      ...
      <div v-if="isEdit" class="row">
        <div class="input-field col s4">
          <a
            class="waves-effect waves-light btn-small grey lighten-4 black-text"
      ...
      <meta-dates :show="isEdit" :created="user.created" :updated="user.updated"></meta-dates>
